        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0 me-n3">
                ...
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style={{"color":"#047b93","cursor":"pointer"}} >Add</a>
                    <div class="dropdown-menu m-0">
                        <a class="dropdwn-item"><Link to="/addproject">Add Project</Link></a><br/>
                        <a class="dropdwn-item"><Link to="/addgroup">Add Group</Link></a>
                    </div>
                </div>
